<div class="container">
    <form action="/ppdb" method="POST" enctype="multipart/form-data">
        ...
        <h4 class="d-flex justify-content-center">Data Siswa :</h4>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="nisn-siswa" value="0201034059" name="nisn">
        </div>

        <div class="mb-3">
            <label for="nama-siswa" class="form-label">Nama Lengkap</label>
            <input type="text" class="form-control" id="nama-siswa" value="Yudi Amanda" name="nama_lengkap">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="tanggal-lahir-siswa" name="tanggal_lahir">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nama-ayah" value="Sumandi" name="nama_ayah">
        </div>

        <div class="mb-3">
            <label for="nama-ibu" class="form-label">Nama Ibu</label>
            <input type="text" class="form-control" id="nama-ibu" value="Siti" name="nama_ibu">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control" id="uang-pendaftaran" accept=".jpg, .jpeg, .png"
                name="bukti_pendaftaran_siswa_baru">
        </div>
