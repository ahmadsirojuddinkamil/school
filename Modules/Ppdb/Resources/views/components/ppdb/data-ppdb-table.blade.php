                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer d-flex justify-content-end">
                                        ...
                                        <form
                                            action="{{ route('ppdb.delete', ['save_uuid_from_event' => $dataPpdb->uuid]) }}"
