            ...
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        @if ($dataUserAuth[1] == 'admin')
                            <li>
                                <a href="{{ route('ppdb.year') }}"
                                    class="{{ Request::is('ppdb-data/*') ? 'active' : '' }}">Ppdb</a>
                            </li>
                ...
                {{-- <li class="submenu">
                    <a href="javascript:void(0);"><img src="assets/dashboard/img/icons/sales1.svg" alt="img"><span>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="assets/dashboard/img/icons/purchase1.svg"
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="assets/dashboard/img/icons/expense1.svg"
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="assets/dashboard/img/icons/quotation1.svg"
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="assets/dashboard/img/icons/transfer1.svg"
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="assets/dashboard/img/icons/return1.svg"
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="assets/dashboard/img/icons/users1.svg" alt="img"><span>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="assets/dashboard/img/icons/places.svg" alt="img"><span>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="assets/dashboard/img/icons/product.svg"
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="assets/dashboard/img/icons/time.svg"
                            alt="img"><span>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="assets/dashboard/img/icons/users1.svg"
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="assets/dashboard/img/icons/settings.svg"
