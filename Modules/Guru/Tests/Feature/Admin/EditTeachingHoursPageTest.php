...
class EditTeachingHoursPageTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_edit_data_guru_page_success_displayed(): void
    {
        ...
        $response = $this->get('/data-guru/' . $guru->uuid . '/edit/teaching-hours');
    ...
    public function test_edit_data_guru_page_failed_because_not_uuid(): void
    {
        ...
        $response = $this->get('/data-guru/uuid/edit/teaching-hours');
    ...
    public function test_edit_data_guru_page_failed_because_data_not_found(): void
    {
        ...
        $response = $this->get('/data-guru/f2a7e279-f7fe-43a2-8a2c-489f3f60574d/edit/teaching-hours');
        $response->assertStatus(302);
        $response->assertRedirect('/data-guru');
        $this->assertTrue(session()->has('error'));
