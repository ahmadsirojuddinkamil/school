<form action="{{ route('store.mata.pelajaran') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="mb-3">
        ...
        <input type="time" step="any" class="form-control" id="jam_awal" name="jam_awal" required>
    </div>
    @error('jam_awal')
    <div class="alert alert-danger">{{ $message }}</div>
    @enderror
    ...
    <div class="mb-3">
        ...
        <input type="time" step="any" class="form-control" id="jam_akhir" name="jam_akhir" required>
    </div>
    @error('jam_akhir')
    <div class="alert alert-danger">{{ $message }}</div>
    @enderror
    ...
    @if($listNameGuru->count() === 0)
        <div class="mb-3">
            <label for="name_guru" class="form-label">Guru</label>
            <input type="text" class="form-control" id="name_guru" name="name_guru" value="" placeholder="belum ada guru!" required readonly>
        </div>
    @else
        <div class="mb-3">
            <label for="name_guru" class="form-label">Guru</label>
    ...
    <div class="mb-3">
        ...
        <input type="file" class="form-control" id="materi_pdf" name="materi_pdf" accept=".zip, .rar">
    </div>
    @error('materi_pdf')
    <div class="alert alert-danger">{{ $message }}</div>
    @enderror
    ...
    <div class="mb-3">
        ...
        <input type="file" class="form-control" id="materi_ppt" name="materi_ppt" accept=".zip, .rar">
    </div>
    @error('materi_ppt')
    <div class="alert alert-danger">{{ $message }}</div>
    @enderror
    ...
    <div class="col-lg-12">
        <div class="form-group">
            <label>Foto</label>
            <input type="file" id="fileInput" class="form-control" name="foto" accept=".jpg, .jpeg, .png" onchange="validateFile(this)">
            <br><br>
            <img id="previewImageMataPelajaran" src="{{ asset('assets/dashboard/img/mapel.png')  }}" alt="foto-mata-pelajaran" height="100" width="100">
        </div>
    </div>
    @error('foto')
    <div class="alert alert-danger">{{ $message }}</div>
...
<script>
    function validateFile(input) {
        ...
        const defaultImage = `{{ asset('assets/dashboard/img/mapel.png') }}`;
