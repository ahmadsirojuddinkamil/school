...
class DeleteDateAbsenSiswaTest extends TestCase
{
    ...
    public function test_delete_date_absen_siswa_success(): void
    {
        ...
        $response = $this->delete('/data-absen/siswa/tanggal', [
            'uuid' => $absen->uuid,
        ]);
    ...
    public function test_delete_date_absen_siswa_failed_because_not_super_admin(): void
    {
        $this->roleService->createRole();
    ...
    public function test_delete_date_absen_siswa_failed_because_form_is_empty(): void
    {
        $this->roleService->createRole();
        $user = $this->roleService->createUserSuperAdmin();
        session(['userData' => [$user, 'super_admin']]);
    ...
    public function test_delete_date_absen_siswa_failed_because_data_not_found(): void
    {
        $this->roleService->createRole();
        $user = $this->roleService->createUserSuperAdmin();
        session(['userData' => [$user, 'super_admin']]);
