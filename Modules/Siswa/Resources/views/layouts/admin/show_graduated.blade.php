        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="page-header">
                    ...
                    <div class="wordset">
                        <ul>
                            <a href="{{ route('siswa.graduated.download.pdf', $dataSiswa->uuid) }}" class="link-with-margin">
                                <img src="{{ asset('assets/dashboard/img/icons/pdf.svg') }}" alt="img">
                            </a>

                            <a href="{{ route('siswa.graduated.download.excel', $dataSiswa->uuid) }}" class="link-with-margin">
