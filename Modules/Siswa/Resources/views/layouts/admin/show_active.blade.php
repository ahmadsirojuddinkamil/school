...
<head>
    ...
    <title>Dashboard | biodata {{ $getDataSiswa->name }}</title>
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="page-header">
                    ...
                    <div class="wordset">
                        <ul>
                            <a href="{{ route('siswa.active.download.pdf', $getDataSiswa->uuid) }}" class="link-with-margin">
                                <img src="{{ asset('assets/dashboard/img/icons/pdf.svg') }}" alt="img">
                            </a>

                            @if(in_array($dataUserAuth[1], ['super_admin', 'admin']))
                            <a href="{{ route('siswa.active.download.excel', $getDataSiswa->uuid) }}" class="link-with-margin">
