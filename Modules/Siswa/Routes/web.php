...
Route::controller(SiswaController::class)->middleware('auth')->group(function () {
    Route::group(['middleware' => ['role:admin|super_admin']], function () {
        ...
        Route::get('/data-siswa/aktif/{save_uuid_from_event}/download/excel', 'downloadExcelSiswaActive')->name('siswa.active.download.excel');
        ...
        Route::get('/data-siswa/graduated/{save_uuid_from_event}/download/pdf', 'downloadPdfSiswaGraduated')->name('siswa.graduated.download.pdf');
        ...
        Route::get('/data-siswa/graduated/{save_uuid_from_event}/download/excel', 'downloadExcelSiswaGraduated')->name('siswa.graduated.download.excel');
    ...
    Route::group(['middleware' => ['role:admin|super_admin|siswa']], function () {
        ...
        Route::get('/data-siswa/aktif/{save_uuid_from_event}/download/pdf', 'downloadPdfSiswaActive')->name('siswa.active.download.pdf');
